...
timeout --preserve-status 60s falco -c /etc/falco/falco.yaml -r /etc/falco/falco_rules.yaml -r /etc/falco/falco-sandbox_rules.yaml -r ./ipv4-outbound-rules.yaml -r ./ipv6-outbound-rules.yaml -r ./cidr-outbound-rules.yaml -r ./ipv4-inbound-rules.yaml -r ./ipv6-inbound-rules.yaml -r ./cidr-inbound-rules.yaml
status=$?
if [ $status -eq 0 ]; then
