...
def fetchMISPIndicators(ip4_outbound_list, ip6_outbound_list, domain_list, file_list, sha256_dict, uri_list,cidr_list):
    ...
    ip4_outbound_list, ip6_outbound_list, domain_list, file_list, sha256_dict, uri_list, cidr_list = pyMISPGetNewIndicatorsByAttributes(ip4_outbound_list_list, ip6_outbound_list, domain_list, file_list, sha256_dict, uri_list, cidr_list, indicatorAfterTimestamp)
    if debug == True: printListSizes(ip4_outbound_list, ip6_outbound_list, domain_list, file_list, uri_list,cidr_list, sha256_dict)
    if debug == True: print("Finished Fetching New Indicators from Attributes for server: "+ misp_server_url)
    
    
    return ip4_outbound_list, ip6_outbound_list, domain_list, file_list, sha256_dict, uri_list, cidr_list
...
def pyMISPGetNewIndicatorsByAttributes(ip4_outbound_list, ip6_outbound_list, domain_list, file_list, sha256_dict, uri_list, cidr_list, indicatorAfterTimestamp):
    ...
    for attribute in misp_response['Attribute']:
        ...
        if int(attribute["timestamp"]) > int(indicatorAfterTimestamp):
            ...
            match ioc_type: 
                ...
                case "ip-dst":
                    ip4_outbound_list, ip6_outbound_list, cidr_list = checkIP(ioc_value, ip4_outbound_list, ip6_outbound_list, cidr_list)
                case "domain":
